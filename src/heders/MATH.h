...
/**
 ** a function that returns a difference of cosines
 * @param angle1
 * @param angle2
...
/**
 ** a function that returns a cosine of angles difference cos(alfa-beta)
 * @param angle1
 * @param angle2
...
/**
 ** a function that returns a distance between two Positions
 * @param p1
 * @param p2
...
/**
 ** a function that returns a sine of angles difference sin(alfa-beta)
 * @param angle1
 * @param angle2
...
/**
 ** a function that returs a squared value
 * @param val
 * @return val^2
 */
